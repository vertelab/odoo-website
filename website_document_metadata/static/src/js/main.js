(function () {
    ...
    website.add_template_file('/website_document_metadata/static/src/xml/website.editor.xml');
    ...
    website.editor.ImageDialog = website.editor.Media.extend({
        ...
        try_remove: function (e) {
            ...
            // changt try_remove method that returns redirect to backend instead of remove attachment
            return openerp.jsonRpc('/website_document_redirect', 'call', {
                'id': id,
            }).then(function(url){
