        ...
        def response_wrap(*args, **kw):
            ...
            if routing.get('key'): # Function that returns a raw string for key making
                ...
                key_raw = routing['key'](kw).format(path=request.httprequest.path,
                                                    ...
                                                    country='%s' % request.env.user.partner_id.commercial_partner_id.country_id.code if request.env.user.partner_id.commercial_partner_id.country_id.code else 'SE',
                                                    post='%s' % kw,
